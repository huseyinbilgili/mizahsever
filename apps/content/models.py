...
class Content(AuthTimeStampedModel):
    ...
    status = models.PositiveSmallIntegerField(
        ...
        default=CONTENT_STATUSES.created,
        db_index=True,
    )
...
class ContentMedia(AuthTimeStampedModel):
    ...
    cover_image = models.ImageField(upload_to=generate_filename("media/content/cover_images"))
    duration = models.PositiveSmallIntegerField(default=0)
    preview = models.FileField(
        upload_to=generate_filename("media/content/previews"),
        null=True,
        blank=True,
    )
    file = models.FileField(upload_to=generate_filename("media/content/videos"))
    status = models.PositiveSmallIntegerField(
        choices=CONTENT_MEDIA_STATUSES,
        default=CONTENT_MEDIA_STATUSES.created,
        db_index=True,
    )
